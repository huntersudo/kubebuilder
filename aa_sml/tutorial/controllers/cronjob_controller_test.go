...
// 理想情况下，每个控制器都应该存在对应的测试文件 <kind>_conroller_test.go，并在 test_suite.go 中调用。 接下来，让我们为CronJob控制器编写示例测试
//todo 这些测试示例使用了 Ginkgo (BDD-style Go 测试框架)。学习更多关于 Ginkgo 请参考 http://onsi.github.io/ginkgo/。
...
var _ = Describe("CronJob controller", func() {
	...
	Context("When updating CronJob Status", func() {
		It("Should increase CronJob Status.Active count when new Jobs are created", func() {
			...
			//todo 创建操作可能不会立马完成，因此我们需要多次重试去获取这个新建的 CronJob。
...
//https://github.com/Azure/azure-databricks-operator/blob/0f722a710fea06b86ecdccd9455336ca712bf775/controllers/suite_test.go
//Azure Databricks Operator: 仔细阅读 suite_test.go 以及那个目录下所有的 *_test.go 文件 例如这个。
